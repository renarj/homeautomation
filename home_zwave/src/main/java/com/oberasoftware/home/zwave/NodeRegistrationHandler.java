...
import static com.oberasoftware.home.api.events.devices.DeviceInformationEvent.EVENT_TYPE.NEW_DEVICE;
...
public class NodeRegistrationHandler implements EventListener<NodeRegisteredEvent> {
    ...
    public void receive(NodeRegisteredEvent event) throws Exception {
        automationBus.publish(new DeviceInformationEvent(NEW_DEVICE, deviceRegistry.getZwaveId(), new ZWaveDevice(event.getNode())));
    }
