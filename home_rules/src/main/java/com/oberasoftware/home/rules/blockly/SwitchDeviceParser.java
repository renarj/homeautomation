 ...
 */
@Component
public class SwitchDeviceParser implements FragmentParser<ItemAction> {
    private static final Logger LOG = getLogger(SwitchDeviceParser.class);

    @Override
    public boolean supportsType(String type) {
        return type.equals("switchdevice");
    }
